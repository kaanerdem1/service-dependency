/**
 * Tam BPM canvas state + React Flow (ProcessFlowMapInner).
 */
...
import { ProcessFlowDetailDrawer } from '../ProcessFlowDetailDrawer.js'
import { ProcessFlowScreens } from '../ProcessFlowScreens.js'
import { ProcessFlowMapSearch } from '../ProcessFlowMapSearch.js'
import { processFlowSearchMatches } from '../processFlowMapSearchMatch.js'
import {
  graphNodeIdSet,
  incomingTransitionsFor,
  outgoingTransitionsFor,
} from '../processFlowDrawerNav.js'
import { buildPathSnapshotSteps } from '../processPathNarrative.js'
import { exportProcessPathSnapshotPdf } from '../../../snapshot/processPathSnapshot.js'
import {
  NOTE_DEFAULT_HEIGHT,
  NOTE_DEFAULT_WIDTH,
  writeProcessFlowNotes,
} from '../processFlowNotes.js'
import { summarizeProcessFlow } from '../processFlowSummary.js'
...
import {
  ...
  startCamera,
} from '../processFlowCamera.js'
import { useProcessFlowHover } from '../useProcessFlowHover.js'
import {
  buildDag,
  buildGraph,
  focusHighlightFor,
...
import { EdgeMarkers, FullscreenGlyph, processFlowEdgeTypes } from './edges.js'
import { processFlowNodeTypes, type NoteNodeData } from './nodes.js'
import { noteActions, noteNodesFromStorage, notesFromNodes } from './noteNodes.js'
import type { ProcessEdgeData, ProcessFlowMapProps } from './types.js'

function nextFrame(): Promise<void> {
  return new Promise((resolve) => requestAnimationFrame(() => resolve()))
}

export function ProcessFlowMapCore({
  graph,
  processScreens = [],
  onDismiss,
  canGoBack,
