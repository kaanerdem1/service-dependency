/**
 * Web mock servis kataloğu (server/src/data.ts ile aynı model).
 * affectsEdges[callee] = onu çağıranlar → değişince etkilenenler.
 */
...
const serviceDefs: Omit<Service, 'affectedCount' | 'dependsOnCount'>[] = [
  ...
  {
    id: 'svc-checkout',
    name: 'retail_checkout_order_cart_orchestration_workflow_engine',
    projectId: 'proj-commerce',
  ...
  {
    id: 'svc-billing',
    name: 'customer_billing_invoice_tax_reconciliation_engine',
    projectId: 'proj-commerce',
    packageId: 'pkg-payments',
    owner: owners.o1,
  },
  {
    id: 'svc-refund',
    name: 'customer_refund_chargeback_reversal_settlement_processor',
    projectId: 'proj-commerce',
    packageId: 'pkg-payments',
    owner: owners.o1,
  },
  {
    id: 'svc-identity',
    name: 'enterprise_identity_session_directory_access_control',
  ...
  {
    id: 'svc-notify',
    name: 'outbound_multichannel_notification_delivery_router',
    projectId: 'proj-platform',
  ...
  {
    id: 'svc-storefront',
    name: 'digital_storefront_catalog_checkout_experience_api',
    projectId: 'proj-commerce',
    packageId: 'pkg-orders',
    owner: owners.o2,
  },
  {
    id: 'svc-mobile-bff',
    name: 'mobile_channel_backend_for_frontend_gateway_adapter',
    projectId: 'proj-commerce',
    packageId: 'pkg-orders',
    owner: owners.o2,
  },
  {
    id: 'svc-report',
    name: 'enterprise_operational_reporting_analytics_pipeline',
    projectId: 'proj-data',
  ...
  },
  {
    ...
    name: 'overnight_general_ledger_finance_batch_import_job_runner',
    projectId: 'proj-data',
    packageId: 'pkg-reporting',
    owner: owners.o5,
  },
  {
    id: 'svc-support-desk',
    name: 'customer_support_desk_case_routing_orchestrator',
    projectId: 'proj-platform',
    packageId: 'pkg-notify',
    owner: owners.o4,
  },
  {
    ...
    name: 'customer_care_interaction_history_assistance_portal',
    projectId: 'proj-platform',
    packageId: 'pkg-notify',
    owner: owners.o4,
  },
  {
    ...
    name: 'support_ticket_analytics_insight_warehouse_service',
    projectId: 'proj-data',
    packageId: 'pkg-reporting',
    owner: owners.o5,
  },
